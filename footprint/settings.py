...
USE_LOCAL_SAMPLE_DATA_SETS = True
...
FOOTPRINT_TEMPLATE_DIR = os.path.join(ROOT_PATH, "main/templates/footprint")
...
SERVER_ROOT = '/srv/calthorpe/urbanfootprint'
FAB_EXEC = '/srv/calthorpe_env/bin/fab'
...
PATH_CONFIGURATIONS = {
    ...
    'jenkins': dict(
        ...
        BASE_PATH='/var/lib/jenkins/jobs/FootprintTests/workspace',
        PYTHON_INTERPRETER='/var/lib/jenkins/jobs/FootprintTests/workspace/calthorpe_ve/bin/python',
        SERVER_ROOT='/var/lib/jenkins/jobs/FootprintTests/workspace',
        PROJ_ROOT='/var/lib/jenkins/jobs/FootprintTests/workspace/footprint',
        WEBSOCKETS_ROOT='/var/lib/jenkins/jobs/FootprintTests/workspace/websockets'
    )
}

try:
    from footprint.local_settings import *
except ImportError:
