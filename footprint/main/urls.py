...
from footprint.main.resources.analytic_resources import CoreResource #, FiscalResource
from footprint.main.resources.built_form_resources import BuiltFormResource, BuiltFormSetResource, PlacetypeResource, \
    ...
    BuildingUsePercentResource, BuildingAttributeSetResource, BuiltFormExampleResource, PlacetypeComponentPercentResource, PrimaryComponentResource, PrimaryComponentPercentResource
...
from footprint.main.resources.config_entity_resources import GlobalConfigResource, RegionResource, ProjectResource, ScenarioResource, ConfigEntityResource, FutureScenarioResource, BaseScenarioResource
...
#v1_api.register(FiscalResource())
