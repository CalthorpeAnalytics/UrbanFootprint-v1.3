...
from footprint.main.lib.functions import map_to_keyed_collections
...
class ConfigEntitySelection(object):
    ...
    def _select(self, attribute, value):
        ...
        # Store the id here to prevent the entire object from being pickled
    ...
    def _selected(self, attribute):
        ...
        raise Exception("Instance {0} has no {1} selected does not return exactly one set, but returns {2}".format(
            self,
            attribute,
