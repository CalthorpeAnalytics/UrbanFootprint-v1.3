...
class FiscalUpdaterTool(AnalysisTool):
    ...
    def run_fiscal_calculations(self, **kwargs):
        ...
        policy_assumptions = {}
        policy_set = self.config_entity.selected_policy_set().policy_by_key('fiscal')
        ...
        fiscal_feature_class = self.config_entity.db_entity_feature_class(DbEntityKey.FISCAL, base_class=True)
