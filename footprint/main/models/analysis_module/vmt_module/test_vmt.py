...
def test_execute_vmt(config_entity):
...
def run_vmt_model(config_entity):
    ...
    one_mile_buffer_class = config_entity.db_entity_feature_class(DbEntityKey.VMT_ONE_MILE_BUFFER)
    quarter_mile_buffer_class = config_entity.db_entity_feature_class(DbEntityKey.VMT_QUARTER_MILE_BUFFER)
    variable_buffer_class = config_entity.db_entity_feature_class(DbEntityKey.VMT_VARIABLE_BUFFER)
    vmt_result_class = config_entity.db_entity_feature_class(DbEntityKey.VMT)
    ...
    if isinstance(config_entity.subclassed_config_entity, FutureScenario):
        ...
        demographic_class = config_entity.db_entity_feature_class(DbEntityKey.END_STATE_DEMOGRAPHIC)
        ...
        demographic_class = config_entity.db_entity_feature_class(DbEntityKey.BASE_DEMOGRAPHIC)
