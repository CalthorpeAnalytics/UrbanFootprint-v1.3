...
# TODO This is intended to provide an object-oriented structure to analytic modules
# It's not in use yet but probably will work
class CeleryTask(Task):
    ...
    def run(self, *args, **kwargs):
        ...
        """
        analysis_module = self.resolve_analyis_module(**kwargs)
        config_entity = ConfigEntity.objects.get(analysis_module.config_entity.id).all().select_subclasses()
