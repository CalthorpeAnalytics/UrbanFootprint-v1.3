...
class DynamicModelClassCreator(object):
    ...
    def __init__(self, config_entity=None, configuration_or_container=None, no_ensure=False):
        ...
        self.config_entity = config_entity.subclassed_config_entity if config_entity and config_entity.__class__ in [ConfigEntity, Scenario] else config_entity
    ...
    def create_related_field(self, field_name, related_field_configuration):
        ...
        config_entity = ConfigEntity._subclassed_config_entity_by_id(self.configuration.scope)
