...
class DevelopableFeature(Feature):
    ...
    api_include = ['acres_developable', 'developable_index', 'acres_gross', 'acres_parcel', 'pop', 'hh', 'du', 'du_detsf', 'du_attsf', 'du_mf', 'emp', 'emp_ret', 'emp_off', 'emp_pub', 'emp_ind', 'emp_ag', 'emp_military', 'acres_parcel_res', 'acre_parcels_emp', 'acres_parcel_mixed', 'acres_parcel_no_use']

    developable_index = models.DecimalField(max_digits=14, decimal_places=6, default=1)
