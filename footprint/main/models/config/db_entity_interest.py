...
class DbEntityInterest(Deletable):
    ...
    def feature_fields(self):
        ...
        return feature_class_creator.dynamic_feature_class().objects.all().result_fields_and_title_lookup()[0] if feature_class else []
    ...
    def feature_field_title_lookup(self):
        ...
        if not feature_class_creator.feature_class_is_ready:
            return {}
        feature_class = feature_class_creator.dynamic_feature_class()
        return feature_class_creator.dynamic_feature_class().objects.all().result_fields_and_title_lookup()[1] if feature_class else {}
