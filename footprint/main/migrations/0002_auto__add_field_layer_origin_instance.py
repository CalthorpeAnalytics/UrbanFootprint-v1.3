...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.origin_instance'
        db.add_column('main_layer', 'origin_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Layer'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.origin_instance'
        db.delete_column('main_layer', 'origin_instance_id')
