...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.create_from_selection'
        db.add_column('main_layer', 'create_from_selection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.create_from_selection'
        db.delete_column('main_layer', 'create_from_selection')
