...
from footprint.main.initialization.fixture import LayerConfigurationFixture
from footprint.main.publishing.layer_initialization import LayerLibraryKey, LayerTag
...
class TestLayerPublishing(unittest.TestCase):
    ...
    def test_layer_setup(self):
        ...
        assert_equal(
            len(layer_library.presentation_media.filter(tag__contains=[LayerTag.BACKGROUND_IMAGERY])),
