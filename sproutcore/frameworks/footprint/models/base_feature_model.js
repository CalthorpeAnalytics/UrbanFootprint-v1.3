...
Footprint.BaseFeature.mixin({
    priorityProperties: function () {
        return ['built_form', 'region_lu_code', 'pop', 'du', 'emp'];
    },
    excludeProperties: function () {
        return ['config_entity', 'wkb_geometry']
    }
});


Footprint.BaseDemographicFeature = Footprint.Feature.extend({})