    ...
    savingMainRecordState:SC.State.extend({
        ...
        enterState: function(context) {
            ...
            this.recordToClonePropertyHashes = $.mapToCollectionsObject(
                ...
                function(record) {
                    deferredProperties.map(function(cloneProperty) {
        ...
        _recordStatusDidChange: function() {
            ...
            if (this._recordsQueue.length == 0) {
                ...
                this._finished = YES;
                this.gotoState('%@.savingAfterRecordsState'.fmt(this.getPath('parentState.fullPath')), this.getPath('parentState._context'));
            }
        }
    }),
