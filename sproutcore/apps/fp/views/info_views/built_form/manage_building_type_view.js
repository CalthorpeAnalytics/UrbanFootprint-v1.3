...
sc_require('views/info_views/built_form/editable_building_type_attributes_view');
...
Footprint.ManageBuildingTypeView= SC.View.extend(SC.ActionSupport,{
    classNames: ['footprint-add-building-type-view'],
    layout: {top:27},

    childViews:['overlayView', 'builtFormTopView', 'editableBuildingTypeAttributesView', 'buildingTypeSummaryAttributesView', 'buildingTypeListView', 'buttonsView'],
    ...
    selection: null,
    selectionBinding: SC.Binding.from('Footprint.buildingTypesEditController.selection'),
    ...
    editableBuildingTypeAttributesView: Footprint.EditableBuildingTypeAttributesView,

    buildingTypeSummaryAttributesView: Footprint.BuiltFormSummaryAttributesView.extend({
        contentBinding: SC.Binding.oneWay('.parentView.selectedItem')
    }),

    buildingTypeListView: Footprint.BuiltFormItemsScrollView.extend({
