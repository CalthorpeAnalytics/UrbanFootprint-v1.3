...
sc_require('views/info_views/built_form/editable_crop_types_of_landscape_type_view');
sc_require('views/info_views/built_form/agriculture_built_forms/agriculture_summary_attributes_view');
...
Footprint.ManageLandscapeTypeView= Footprint.ManageBuiltFormView.extend(SC.ActionSupport,{
    ...
    childViews:[
        ...
        'overlayView',
        'builtFormTopView',
        'editableCropTypesOfLandscapeTypeView',
        'landscapeTypeSummaryAttributesView',
        'toggleButtonsView',
        'builtFormColorPickerView'
    ],

    recordType: Footprint.LandscapeType,
    recordsEditControllerBinding: SC.Binding.oneWay('Footprint.landscapeTypesEditController'),
    ...
    builtFormTopView: Footprint.EditableBuiltFormTopView.extend({
        ...
        titleValue: 'LandscapeType:'
    }),

    editableCropTypesOfLandscapeTypeView: Footprint.EditableCropTypesOfLandscapeTypeView.extend({
        title:"CropTypes in LandscapeType",
        layout: {top:70, height: 225, left: 340, right: 280},
        contentBinding: SC.Binding.oneWay('.parentView.selectedItem.primary_component_percents')
    }),
    ...
    landscapeTypeSummaryAttributesView: Footprint.AgricultureSummaryAttributesView.extend({
        layout: {left: 970, width: 260, height: 0.6},
        editController: Footprint.landscapeTypesEditController,
        componentPercentObserverBinding: SC.Binding.oneWay('Footprint.landscapeTypesEditController.updateSummaryAttributes'),
        contentBinding: SC.Binding.oneWay('.parentView*selectedItem'),
    }),
