...
Footprint.QueryInfoView = Footprint.InfoView.extend({
    ...
    isEnabledBinding: SC.Binding.oneWay('.content.status').matchesStatus(SC.Record.READY),
    ...
    contentView: SC.View.extend({
        ...
        joinView: Footprint.SelectInfoView.extend({
            ...
            layout: {left: 0.02, width:0.42, top:53, height: 24},
            title: 'Join:',
            recordType:null,
            recordTypeBinding:SC.Binding.oneWay('.parentView.recordType'),
            contentBinding: SC.Binding.oneWay('Footprint.joinLayersController.content'),
        ...
        joinColumnsView: Footprint.SelectInfoView.extend({
            ...
            layout: {left: 0.4, width:0.5, top:53, height: 24},
            title: '',
            recordType:null,
            recordTypeBinding:SC.Binding.oneWay('.parentView.recordType'),
