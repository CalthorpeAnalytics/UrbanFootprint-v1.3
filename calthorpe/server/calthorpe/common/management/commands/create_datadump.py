...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #################
        #rsync folder
        rsync+= ' -rapthzv {extra} {src} {dest}'.format(extra=settings.CALTHORPE_DAILY_DUMP_RSYNC_EXTRA_PARAMS,
        ...
        with postgres_env_password_loaded(settings.DATABASES['default']):
