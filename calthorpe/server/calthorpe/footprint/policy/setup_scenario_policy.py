...
from sql_unformatted import rawSQL
...
def get_energy_water(scenario):
    from footprint.models.energy_water import EnergyWater
    try:
...
def get_dev_acres(scenario):
    from footprint.models.dev_acres import DevAcres
    try:
...
post_syncdb.connect(on_post_syncdb, sender=footprint.models)
