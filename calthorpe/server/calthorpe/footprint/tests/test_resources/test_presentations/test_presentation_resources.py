...
from footprint.models import Presentation
...
class PresentationResourceTest(ResourceTests):
    """
    ...
    def list_generator(self):
        ...
        return DataProvider().presentation_config().presentation_set.all()()
...
class TestMapResource(ConfigEntityResourceTest):
...
class TestResultPageResource(ConfigEntityResourceTest):
