...
from footprint.models import LayerLibrary
...
class TestLayerSelection(unittest.TestCase):
    ...
    def test_selection(self):
        ...
        layer = layer_library.presentationmedium_set.filter(db_entity_key=Keys.DB_ABSTRACT_FUTURE_SCENARIO_FEATURE).select_subclasses()[0]
