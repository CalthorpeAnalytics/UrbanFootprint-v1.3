...
class TestCore(TestConfigEntity):
    ...
    def test_scenario_core(self):
        ...
        scenario_built_form_feature_manager = scenario.feature_class_of_db_entity('scenario_built_form_layer').objects
        ...
        for db_entity_key in [Keys.DB_ABSTRACT_GROSS_INCREMENT_FEATURE, Keys.DB_ABSTRACT_INCREMENT_FEATURE,
            ...
            FeatureClass = scenario.feature_class_of_db_entity(db_entity_key)
