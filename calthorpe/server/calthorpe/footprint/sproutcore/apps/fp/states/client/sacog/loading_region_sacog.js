 ...
 * @type {*}
 */
Footprint.LoadingRegionSacogLandUseDefinitionState = Footprint.LoadingState.design({
...
Footprint.LoadingRegionSacogState = Footprint.State.design({
   initialSubstate:'loadingRegionSacogLandUseDefinitionState',
   loadingRegionSacogLandUseDefinitionState: Footprint.LoadingRegionSacogLandUseDefinitionState
});
