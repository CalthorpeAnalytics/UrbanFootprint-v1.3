...
sc_require('controllers/client/client_land_use_definition_controller');
sc_require('models/client/client_land_use_definition_model');

/***
 * Loads controllers specific to scag
 * @type {*}
 */
Footprint.LoadingRegionScagLandUseDefinitionState = Footprint.LoadingState.design({
...
Footprint.LoadingRegionScagState = Footprint.State.design({
   initialSubstate:'loadingRegionScagLandUseDefinitionState',
   loadingRegionScagLandUseDefinitionState: Footprint.LoadingRegionScagLandUseDefinitionState
});
