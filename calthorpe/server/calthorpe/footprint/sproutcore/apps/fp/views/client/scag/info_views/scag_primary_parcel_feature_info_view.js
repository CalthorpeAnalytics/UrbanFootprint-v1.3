...
Footprint.ScagPrimaryParcelFeatureInfoView = Footprint.FeatureEditView.extend({
    classNames: 'footprint-primary-base-feature-info-view'.w(),
    ...
    recordType: Footprint.ScagExistingLandUseParcelFeature,
    content: null,
