...
$.extend({
    ...
    /**
     * Grep until a matching item is found, then return it, else null
     * @param list
     * @param func
     * @returns {null}
     */
    firstMatch: function(list, func) {
        var ret = null;
        $.each(list, function(index, value) {
            if (func(value, index)) {
                ret = value;
    ...
    */
    ...
    mapToCollectionsObjectWithObjectKeys: function(array, keyFunc, valueFunc, keyToString, objectType) {
        ...
        $.each(array, function(index, value) {
            ...
            $.each(jQuery.isArray(key) ? key : [key], function(i, k) {
                keyString = keyToString(k);
