...
function arrayOrItemToArray(array) {
    // TODO I should be able to simply check kindOf(SC.Array) here
    if (array.kindOf && (array.kindOf(SC.Enumerable) || array.kindOf(SC.ChildArray) || array.kindOf(SC.ManyArray) || array.kindOf(SC.RecordArray) ))
 ...
 * @returns {*}
 */
function mapToSCObject(array, func) {
    return SC.Object.create($.mapToDictionary(array, func));
}
