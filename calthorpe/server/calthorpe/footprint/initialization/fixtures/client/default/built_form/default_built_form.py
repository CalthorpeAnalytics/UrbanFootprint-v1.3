...
from footprint.models import BuildingUsePercent, PlacetypeComponentPercent, PrimaryComponent, \
    PrimaryComponentPercent, Placetype, BuildingAttributeSet, PlacetypeComponent

from footprint.initialization.fixture import BuiltFormFixture
...
from footprint.tests.test_data.sample_built_form_sets import load_placetype_csv
from settings import TEST_SKIP_BUILT_FORM_COMPUTATIONS, SKIP_ALL_BUILT_FORMS
import settings
...
class DefaultBuiltFormFixture(DefaultMixin, BuiltFormFixture):
    ...
    def built_forms(self, client='default'):
        ...
        from footprint.models.built_form.primary_component import on_instance_modify as on_primary_component_modify
        ...
        if not TEST_SKIP_BUILT_FORM_COMPUTATIONS:
        ...
        from footprint.models.built_form.placetype_component import on_instance_modify as on_placetype_component_modify
        ...
        for placetype_dict in built_forms_dict['placetypes']:
            ...
            placetype.update_or_create_built_form_examples()
    ...
    def tag_built_forms(self, built_forms_dict, client='default'):
        ...
        for built_form in itertools.chain(built_forms_dict['placetypes'], built_forms_dict['primary_components']):
