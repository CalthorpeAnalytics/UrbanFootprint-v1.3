...
from footprint.initialization.fixtures.client.sacog.built_form.sacog_land_use_definition import DemoLandUseDefinition
...
class DemoPrimaryParcelFeature(PrimaryParcelFeature):
    @classmethod
    ...
    land_use_definition = models.ForeignKey(DemoLandUseDefinition, null=True)
...
class TemplatePrimaryBaseFeature(PrimaryParcelFeature):
    """
