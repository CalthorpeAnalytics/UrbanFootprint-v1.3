...
from footprint.models.built_form.client_land_use import ClientLandUse


class DemoLandUse(ClientLandUse):
    objects = GeoInheritanceManager()
    land_use_definition = models.ForeignKey(DemoLandUseDefinition, null=False)
