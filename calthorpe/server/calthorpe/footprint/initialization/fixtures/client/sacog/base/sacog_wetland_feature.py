...
class SacogWetlandFeature(Feature):
    area = models.DecimalField(max_digits=10, decimal_places=2)
    perimeter = models.DecimalField(max_digits=10, decimal_places=2)
    wetland_code = models.CharField(max_length=20, null=True, blank=True)
...
class TemplateSacogWetlandFeature(SacogWetlandFeature):
    """
